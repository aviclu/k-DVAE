...
def config_logger(log_path='k_dvae.log'):
...
if __name__ == '__main__':
    ...
    log_path = os.path.join(save_dir_name, dataset_name, 'k_dvae.log')
    ...
    model = KDvae(number_cluster=n_cluster, k_dvae_epoch=40, epoch_ae=10, initial_epoch=80, dataset_name=dataset_name)
